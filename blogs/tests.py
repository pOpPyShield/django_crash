...
class BlogTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.post = PostBlog.objects.create(
            title="A good title", body="Nice body contnet", author=cls.user
        )

    def test_post_model(self):
        self.assertEqual(self.post.title, "A good title")
        self.assertEqual(self.post.body, "Nice body contnet")
    ...
    def test_post_createview(self):
        ...
        self.assertEqual(PostBlog.objects.last().title, "New title")
        self.assertEqual(PostBlog.objects.last().body, "New text")
    ...
    def test_post_updateview(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertEqual(PostBlog.objects.last().title, "Updated title")
        self.assertEqual(PostBlog.objects.last().body, "Updated text")
